...
//Fetch UserName
$queryName = "SELECT * FROM um_community WHERE UM_Community_Email = '$email'";
...
<marquee class="marquee" scrolldelay="150"> Welcome <?php echo"".$Name['UM_Community_FullName'].""?>&nbsp;
...
<Header class=headerCentered>
  <h2 style="font-family: 'Times New Roman', Times, serif"><b>Information Corner</b></h2>
  </Header>
<iframe  class="corner" src="(HOME) Noticeboard.php" width="1850px" height="600px"></iframe> 
</div>
