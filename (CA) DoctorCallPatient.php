<?php   
      ...
      //change testing to called
      $query = "UPDATE clinic_appointment SET Doctor_Call_Patient=('CALLED')WHERE Clinic_Appointment_Identity_Credential='$Clinic_Appointment_Identity_Credential' 
      ...
      if ($run) {  
          echo("<script> alert('Patient Called.'); window.location.href='(CA) ClinicAppointmentDoctorView.php'; </script>"); 
      }else{  
