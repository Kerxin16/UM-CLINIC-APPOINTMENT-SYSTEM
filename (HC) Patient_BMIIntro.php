...
<thead>
  ...
  $query = "SELECT * FROM healthcheck_info WHERE healthcheck_info_room= 'BMI'";  
  ...
  $query = "SELECT * FROM healthcheck_info WHERE healthcheck_info_room= 'BMI' LIMIT " . $page_first_result . ',' . $results_per_page;  
    $run = mysqli_query($conn,$query); 
    ...
    ?>
     ...
     for($page = 1; $page<= $number_of_page; $page++) {  
      echo '<a  class="page" href="(HC) Patient_BMIIntro.php?page='. $page .'">' . $page . '</a> ';
    }  
?>
<br>
<br>
