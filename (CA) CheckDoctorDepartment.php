  ...
  <div class="card mt-4">
      <div class="card-body">
        <table class="table">
          <thead>
            <tr>
                <th style="width:5px;font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;font-size:18px">Doctor ID</th>
                 <th style="width:40px;font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;font-size:18px">Doctor Name</th>
                 <th style="width:40px;font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;font-size:18px">Doctor Department</th>
            </tr>
          </thead>
        <tbody>                
         <?php 
           $conn = new mysqli('localhost:3307','root','1234','um_healthcare_system');
              ...
              if(mysqli_num_rows($query_run) > 0){
               ...
               <?php
                  ...
                  <td> </td>
                  <td> </td>
                   <td style="font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;font-size:18px" > <b>Number Of Doctor Shown: </b><?= $SumOfRow= mysqli_num_rows($query_run); ?></td>
                  </tr>
                   <?php
                  }
