<?php   
     ...
     if (isset($_GET['Clinic_Appointment_Identity_Credential'])) {  
...
<div class="content" >
  ...
  <form id="form" action="(HR) MS_HealthRecordBack.php" method="post"  >
  ...
  <tbody>
    ...
    for($page = 1; $page<= $number_of_page; $page++) {  
      ...
      echo '<a  class="page" href="(HR) MS_HRView.php?Clinic_Appointment_Identity_Credential='.$result['Clinic_Appointment_Identity_Credential'].'&& Clinic_Appointment_Speciality='.$result['Clinic_Appointment_Speciality'].'&&page='. $page .'">' . $page . '</a> ';
