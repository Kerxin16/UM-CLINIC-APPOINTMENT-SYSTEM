...
<nav>
    ...
    <li style="float:right" ><a href="(1) LogOut.php"><span class="glyphicon glyphicon-log-in" name="logout" id="logout"></span> Log Out</a></li>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="(HOME) patientHome.php">Home</a>
  <button class="dropdown-btn">Clinic Appointment &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="arrow down"></i>
  </button>
  <div class="dropdown-container">
    <a href="(CA) Patient_Clinic_Appointment1.php">New Appointment Submission</a>
    <a href="(CA) Patient_Check_Appointment_Status.php">Appointment Status</a>
    <a href="(CA) Patient_SelfCheckInCombination.php">Self Check In</a>
  </div>
  <a href="(HR) Patient_HRView.php">Health Record</a>

  <button class="dropdown-btn">Health Check &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="arrow down"></i>
  </button>
  <div class="dropdown-container">
  <a href="(HC) Patient_BMIHome.php">Body Mass Index</a>
  <a href="(HC) Patient_BloodPressureHome.php">Blood Pressure</a>
  <a href="(HC) Patient_HeartRateHome.php">Heart Rate</a>
</div>

  <a href="(HN) Health News Recommendation.php">Health News</a>
  <a href="(SC) PatientHome.php">Support Chat 
    <?php 
