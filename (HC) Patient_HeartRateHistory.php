...
<h2 class="headerCentered"><b>Heart Rate History</b><h2>
...
$sql = "(SELECT HealthCheck_DateTime, Normal_Heart_Rate FROM heartrate where HealthCheck_Email='$email'order by HealthCheck_DateTime desc LIMIT 15 )
ORDER BY HealthCheck_DateTime ASC;";
$result = $conn->query($sql);

$data = array();
$data[] = ['Date Time', 'Normal Heart Rate']; // Add column headers
...
<?php
    while ($row = $result->fetch_assoc()) {
        $data[] = [$row['HealthCheck_DateTime'], (float)$row['Normal_Heart_Rate']];
    }
...
<?php 
    ...
    echo "<span style=\"color:#669999;font-size:20px;  font-family: 'Times New Roman', Times, serif;\"><b>&nbsp;No Heart Rate History Avaialable</b></span>";
}
